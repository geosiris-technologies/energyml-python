...
def read_energyml_xml_bytes(file: bytes):
    return read_energyml_xml_bytes_as_class(file, get_class_from_name(get_class_name_from_xml(get_tree(file))))
...
def read_energyml_xml_str(file_content: str):
    ...
    return parser.from_string(file_content, get_class_from_name(get_class_name_from_xml(get_tree(file_content))))  # , TriangulatedSetRepresentation)
...
def read_energyml_xml_file(file_path: str):
    ...
    return parser.parse(file_path, get_class_from_name(get_class_name_from_xml(get_tree(xml_content))))
